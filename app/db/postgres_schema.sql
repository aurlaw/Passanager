...
-- Started on 2015-07-28 22:07:47 EDT
...
--
-- TOC entry 1986 (class 2604 OID 16699)
...
--
-- TOC entry 1961 (class 2604 OID 16632)
...
--
-- TOC entry 1964 (class 2604 OID 16640)
-- Name: id; Type: DEFAULT; Schema: public; Owner: passanager
--
...
--
-- TOC entry 1967 (class 2604 OID 16648)
...
--
-- TOC entry 1989 (class 2604 OID 16712)
-- Name: logid; Type: DEFAULT; Schema: public; Owner: passanager
--
...
--
-- TOC entry 1971 (class 2604 OID 16660)
-- Name: id; Type: DEFAULT; Schema: public; Owner: passanager
--
...
--
-- TOC entry 1974 (class 2604 OID 16668)
-- Name: id; Type: DEFAULT; Schema: public; Owner: passanager
--
...
--
-- TOC entry 1979 (class 2604 OID 16681)
...
--
-- TOC entry 1983 (class 2604 OID 16690)
...
--
-- TOC entry 1951 (class 2604 OID 16609)
-- Name: userid; Type: DEFAULT; Schema: public; Owner: passanager
--
...
--
-- TOC entry 2003 (class 2606 OID 16721)
...
--
-- TOC entry 2005 (class 2606 OID 16723)
...
--
-- TOC entry 2027 (class 2606 OID 16719)
...
--
-- TOC entry 2011 (class 2606 OID 16727)
...
--
-- TOC entry 2013 (class 2606 OID 16729)
...
--
-- TOC entry 2015 (class 2606 OID 16731)
...
--
-- TOC entry 2017 (class 2606 OID 16733)
...
--
-- TOC entry 2021 (class 2606 OID 16735)
...
--
-- TOC entry 2023 (class 2606 OID 16737)
...
--
-- TOC entry 1993 (class 2606 OID 16943)
...
--
-- TOC entry 1996 (class 2606 OID 16739)
...
--
-- TOC entry 1999 (class 2606 OID 16941)
...
--
-- TOC entry 2000 (class 1259 OID 16944)
...
--
-- TOC entry 2001 (class 1259 OID 16945)
...
--
-- TOC entry 2008 (class 1259 OID 16946)
-- Name: item_isdeleted_idx; Type: INDEX; Schema: public; Owner: passanager; Tablespace: 
--

CREATE INDEX item_isdeleted_idx ON item USING btree (isdeleted DESC);


--
-- TOC entry 2009 (class 1259 OID 16947)
...
--
-- TOC entry 2018 (class 1259 OID 16948)
...
--
-- TOC entry 2019 (class 1259 OID 16949)
...
--
-- TOC entry 1994 (class 1259 OID 16950)
...
--
-- TOC entry 1997 (class 1259 OID 16951)
...
--
-- TOC entry 2028 (class 2606 OID 16930)
-- Name: users_createdby_fkey; Type: FK CONSTRAINT; Schema: public; Owner: passanager
--

ALTER TABLE ONLY users
    ADD CONSTRAINT users_createdby_fkey FOREIGN KEY (createdby) REFERENCES users(userid);


--
-- TOC entry 2029 (class 2606 OID 16935)
-- Name: users_modifiedby_fkey; Type: FK CONSTRAINT; Schema: public; Owner: passanager
--

ALTER TABLE ONLY users
    ADD CONSTRAINT users_modifiedby_fkey FOREIGN KEY (modifiedby) REFERENCES users(userid);
...
-- Completed on 2015-07-28 22:07:47 EDT
